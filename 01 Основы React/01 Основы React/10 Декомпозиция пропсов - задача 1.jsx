...
const Common = props => {
  return (
      <div className='card__data-box'>
        <h2 className='card__subtitle'>{props.сommon.subtitle}</h2>
        <div className='card__two-columns'>
          <p className='card__text'>Годы производства</p>
          <p className='card__text'>{props.сommon.years}</p>
          <p className='card__text'>Класс</p>
          <p className='card__text'>{props.сommon.class}</p>
          <p className='card__text'>Производитель</p>
          <p className='card__text'>{props.сommon.dev}</p>
          <p className='card__text'>Дизайнер</p>
          <p className='card__text'>{props.сommon.dis}</p>
        </div>
      </div>
  )
}
...
const SizeSpecs = props => {
  return (
    <div className='card__data-box'>
      <h2 className='card__subtitle'>{props.sizeSpecs.subtitle}</h2>
      <div className='card__two-columns'>
        <p className='card__text'>Длина</p>
        <p className='card__text'>{props.sizeSpecs.length}</p>
        <p className='card__text'>Ширина</p>
        <p className='card__text'>{props.sizeSpecs.width}</p>
        <p className='card__text'>Высота</p>
        <p className='card__text'>{props.sizeSpecs.height}</p>
        <p className='card__text'>Клиренс</p>
        <p className='card__text'>{props.sizeSpecs.clearance}</p>
        <p className='card__text'>Колёсная база</p>
        <p className='card__text'>{props.sizeSpecs.wheelbase}</p>
        <p className='card__text'>Масса</p>
        <p className='card__text'>{props.sizeSpecs.weight}</p>
      </div>
    </div>
  )
}
...
const SpeedSpecs = props => {
  return (
    <div className='card__data-box'>
      <h2 className='card__subtitle'>{props.speedSpecs.subtitle}</h2>
      <div className='card__two-columns'>
        <p className='card__text'>Разгон до 100 км/ч</p>
        <p className='card__text'>{props.speedSpecs.acceleration}</p>
        <p className='card__text'>Максимальная скорость</p>
        <p className='card__text'>{props.speedSpecs.maxSpeed}</p>
      </div>
    </div>
  )
}
...
const Delorean = () => {
  ...
  return (
    <article className='card'>
      ...
      <Common сommon={data.common} />
      
      <SizeSpecs sizeSpecs={data.sizeSpecs} />
      
      <SpeedSpecs speedSpecs={data.speedSpecs} />
